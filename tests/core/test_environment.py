...
class TestGetResultDir:
    ...
    def test_returns_pathlib_path(self):
        assert isinstance(environment.get_result_dir(), pathlib.Path)
...
class TestGetLogDir:
    ...
    def test_returns_pathlib_path(self):
        assert isinstance(environment.get_log_dir(), pathlib.Path)
...
class TestGetUploadDir:
    ...
    def test_returns_pathlib_path(self):
        assert isinstance(environment.get_upload_dir(), pathlib.Path)
